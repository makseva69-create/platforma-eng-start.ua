...
// !!! УВАГА: ЗАМІНІТЬ ЦЕЙ МАСИВ НА ВАШ ПОВНИЙ СПИСОК ДІЄСЛІВ !!!
// Зверніть увагу, що у вас 93 слова (за скріншотами), 
// тож переконайтеся, що ваш масив містить всі 93 об'єкти.
const verbs = [
